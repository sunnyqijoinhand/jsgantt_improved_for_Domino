    ...
    return (function e(t, n, r) {
        ...
        2: [function(require, module, exports) {
            ...
            exports.GanttChart = function(pDiv, pFormat) {
                ...
                this.vGanttQueryDraw = null; //new options by Sunny Qi , query draw
                this.vGanttPostDraw = null; //new options by Sunny Qi , post draw
                this.vGanttQueryFolderClick = null;
                this.vGanttPostFolderClick = null;
                this.vDivId = null;
                this.vUseFade = 0;
                this.vUseMove = 0;
                this.vUseRowHlt = 1;
                ...
                this.vEditInputEnable = true;
                this.vDebug = false;
                this.vShowSelector = new Array('top');
                this.vDateInputFormat = 'yyyy-mm-dd';
                this.vDateTaskTableDisplayFormat = utils_1.parseDateFormatStr('yyyy-mm-dd');
                this.vDateTaskDisplayFormat = utils_1.parseDateFormatStr('yyyy-mm-dd');
                this.vHourMajorDateDisplayFormat = utils_1.parseDateFormatStr('yyyy-mm-dd day');
                this.vHourMinorDateDisplayFormat = utils_1.parseDateFormatStr('HH');
                this.vDayMajorDateDisplayFormat = utils_1.parseDateFormatStr('yyyy-mm-dd');
                ...
                this.vWeekMinorDateDisplayFormat = utils_1.parseDateFormatStr('mm-dd');
                ...
                this.vUseFullYear = utils_1.parseDateFormatStr('yyyy-mm-dd');
                this.vCaptionType;
                this.vDepId = 1;
                ...
                this.vScrollTo = '';
                this.vMinGpLen = 10; //minus col width =  vMinGpLen*2
                this.vHourColWidth = 20;
                this.vDayColWidth = 30;
                this.vWeekColWidth = 80;
                this.vMonthColWidth = 80;
                this.vQuarterColWidth = 80;
                this.vRowHeight = 20;
                this.vTodayPx = -1;
                this.vLangs = lang;
                this.vLang = 'en';
                ...
                this.CalcTaskXY = function() {
                    ...
                    for (var i = 0; i < vList.length; i++) {
                        ...
                        vPlanBarDiv = vList[i].getPlanBarDiv();
                        ...
                        if (vPlanBarDiv) {
                            vList[i].setPlanStartX(vPlanBarDiv.offsetLeft + 1);
                            vList[i].setPlanStartY(vPlanBarDiv.offsetTop + vPlanBarDiv.offsetTop + vHeight - 1);
                            vList[i].setPlanEndX(vPlanBarDiv.offsetLeft + vPlanBarDiv.offsetWidth + 1);
                            vList[i].setPlanEndY(vPlanBarDiv.offsetTop + vPlanBarDiv.offsetTop + vHeight - 1);
                        }
                    }
                };
                ...
                this.Draw = function() {
                    ...
                    if (this.vEditable) {
                        this.vUseToolTip = false;
                    }
                    if (typeof(this.vGanttQueryDraw) != null) {
                        if (typeof(this.vGanttQueryDraw) == 'function') {
                            this.vGanttQueryDraw(this);
                        }
                    }
                    if (this.vTaskList.length > 0) {
                         ...
                         * HEADINGS
                         */
                        var vTmpDiv = this.newNode(vLeftHeader, 'div', this.vDivId + '_OSgwn_GANTT_LIST_HEAD', 'glistlbl gcontainercol');
                        var vTmpTab = this.newNode(vTmpDiv, 'table', this.vDivId + '_TaskTableHead', 'gtasktableh');
                        var vTmpTBody = this.newNode(vTmpTab, 'tbody');
                        var vTmpRow,
                            vTmpCell;
                        vTmpRow = this.newNode(vTmpTBody, 'tr');
                        this.newNode(vTmpRow, 'td', null, 'gtasklist gselector-row', '\u00A0');
                        vTmpCell = this.newNode(vTmpRow, 'td', null, 'gspanning gtaskname gselector-row');
                        vTmpCell.appendChild(this.drawSelector('top'));
                        if (this.vShowDur == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gduration gselector-row', '\u00A0');
                        if (this.vShowComp == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gpccomplete gselector-row', '\u00A0');
                        if (this.vShowPlanStartDate == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gstartdate gselector-row', '\u00A0');
                        if (this.vShowPlanEndDate == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gplanenddate gselector-row', '\u00A0');
                        if (this.vShowStartDate == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gstartdate gselector-row', '\u00A0');
                        if (this.vShowEndDate == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning genddate gselector-row', '\u00A0');
                        if (this.vShowRes == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gresource gselector-row', '\u00A0');
                        if (this.vShowCost == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gcost gselector-row', '\u00A0');
                        if (this.vShowNotes == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gnotes gselector-row', '\u00A0');
                        if (this.vAdditionalHeaders) {
                            for (var key in this.vAdditionalHeaders) {
                                ...
                                this.newNode(vTmpRow, 'td', null, "gspanning gadditional  gselector-row " + css, '\u00A0');
                            }
                        }
                        vTmpRow = this.newNode(vTmpTBody, 'tr');
                        this.newNode(vTmpRow, 'td', null, 'gtasklist', '\u00A0');
                        this.newNode(vTmpRow, 'td', null, 'gtaskname', '<div></div>');
                        if (this.vShowDur == 1)
                        ...
                        if (this.vShowNotes == 1)
                            this.newNode(vTmpRow, 'td', null, 'gtaskheading gnotes', this.vLangs[this.vLang]['notes']);
                        if (this.vAdditionalHeaders) {
                            for (var key in this.vAdditionalHeaders) {
                                var header = this.vAdditionalHeaders[key];
                         ...
                         *
                         */
                        vTmpDiv = this.newNode(vLeftHeader, 'div', this.vDivId + '_OSgwn_GANTT_LIST_BODY', 'glistlbl gcontainercol gantt-table-row-list-body');
                        this.setListBody(vTmpDiv);
                        vTmpTab = this.newNode(vTmpDiv, 'table', this.vDivId + '_TaskTableBody', 'gtasktableh');
                        ...
                        var _loop_1 = function(i_1) {
                            ...
                            if ((!(this_1.vTaskList[i_1].getParItem() && this_1.vTaskList[i_1].getParItem().getGroup() == 2)) || this_1.vTaskList[i_1].getGroup() == 2) {
                                ...
                                if (this_1.vTaskList[i_1].getGroup() == 1) {
                                    ...
                                    vCellContents += '\u00A0\u00A0\u00A0\u00A0';
                                    var text = makeInput(this_1.vTaskList[i_1].getName(), this_1.vEditable && this_1.vEditInputEnable, 'text');
                                ...
                                if (this_1.vShowDur == 1) {
                                    ...
                                    var text = makeInput(this_1.vTaskList[i_1].getDuration(this_1.vFormat, this_1.vLangs[this_1.vLang]), this_1.vEditable && this_1.vEditInputEnable, 'number', this_1.vTaskList[i_1].getDuration());
                                ...
                                if (this_1.vShowComp == 1) {
                                    ...
                                    var text = makeInput(this_1.vTaskList[i_1].getCompStr(), this_1.vEditable && this_1.vEditInputEnable, 'number', this_1.vTaskList[i_1].getCompVal());
                                    vTmpDiv = this_1.newNode(vTmpCell, 'div', null, null, text);
                                    var callback = function(task, e) {
                                        return task.setCompVal(e.target.value);
                                    };
                                ...
                                if (this_1.vShowPlanStartDate == 1) {
                                    ...
                                    var text = makeInput(v, this_1.vEditable && this_1.vEditInputEnable, 'date', this_1.vTaskList[i_1].getPlanStart());
                                    vTmpDiv = this_1.newNode(vTmpCell, 'div', null, null, text);
                                    var callback = function(task, e) {
                                ...
                                if (this_1.vShowPlanEndDate == 1) {
                                    ...
                                    var text = makeInput(v, this_1.vEditable && this_1.vEditInputEnable, 'date', this_1.vTaskList[i_1].getPlanEnd());
                                    vTmpDiv = this_1.newNode(vTmpCell, 'div', null, null, text);
                                    var callback = function(task, e) {
                                ...
                                if (this_1.vShowStartDate == 1) {
                                    ...
                                    var text = makeInput(v, this_1.vEditable && this_1.vEditInputEnable, 'date', this_1.vTaskList[i_1].getStart());
                                    vTmpDiv = this_1.newNode(vTmpCell, 'div', null, null, text);
                                    var callback = function(task, e) {
                                ...
                                if (this_1.vShowEndDate == 1) {
                                    ...
                                    var text = makeInput(v, this_1.vEditable && this_1.vEditInputEnable, 'date', this_1.vTaskList[i_1].getEnd());
                                    vTmpDiv = this_1.newNode(vTmpCell, 'div', null, null, text);
                                    var callback = function(task, e) {
                                ...
                                if (this_1.vShowRes == 1) {
                                    ...
                                    var text = '';
                                    var i = -1;
                                    if (this_1.vResources != null) {
                                        for (i = 0; i < this_1.vResources.length; i++) {
                                            if (this_1.vTaskList[i_1].getResource() == this_1.vResources[i].id) {
                                                text = this_1.vResources[i].name;
                                                break;
                                            }
                                        }
                                    }
                                    if (text != '') {
                                        text = makeInput(text, this_1.vEditable && this_1.vEditInputEnable, 'resource', this_1.vTaskList[i_1].getResource(), this_1.vResources);
                                    } else {
                                        text = makeInput(this_1.vTaskList[i_1].getResource(), this_1.vEditable && this_1.vEditInputEnable, 'resource', this_1.vTaskList[i_1].getResource(), this_1.vResources);
                                    }
                                    vTmpDiv = this_1.newNode(vTmpCell, 'div', null, null, text);
                                    var callback = function(task, e) {
                                ...
                                if (this_1.vShowCost == 1) {
                                    ...
                                    var text = makeInput(this_1.vTaskList[i_1].getCost(), this_1.vEditable && this_1.vEditInputEnable, 'text');
                                    vTmpDiv = this_1.newNode(vTmpCell, 'div', null, null, text);
                                    var callback = function(task, e) {
                                ...
                                if (this_1.vShowNotes == 1) {
                                    vTmpCell = this_1.newNode(vTmpRow, 'td', null, 'gnotes');
                                    var text = makeInput(this_1.vTaskList[i_1].getNotes().innerHTML, this_1.vEditable && this_1.vEditInputEnable, 'text');
                                    vTmpDiv = this_1.newNode(vTmpCell, 'div', null, null, text);
                                    var callback = function(task, e) {
                                        return task.setNotes(e.target.value);
                                    };
                                    events_1.addListenerInputCell(vTmpCell, this_1.vEventsChange, callback, this_1.vTaskList[i_1], 'notes', this_1.Draw.bind(this_1));
                                    events_1.addListenerClickCell(vTmpCell, this_1.vEvents, this_1.vTaskList[i_1], 'notes');
                                }
                        ...
                        if (this.vShowComp == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gpccomplete gselector-row', '\u00A0');
                        if (this.vShowPlanStartDate == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gplanstartdate gselector-row', '\u00A0');
                        if (this.vShowPlanEndDate == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gplanenddate gselector-row', '\u00A0');
                        if (this.vShowStartDate == 1)
                            this.newNode(vTmpRow, 'td', null, 'gspanning gstartdate gselector-row', '\u00A0');
                        ...
                        vTmpDiv = this.newNode(vRightHeader, 'div', this.vDivId + '_OSgwn_GANTT_CHART_HEAD', 'gchartlbl gcontainercol');
                        this.setChartHead(vTmpDiv);
                        vTmpTab = this.newNode(vTmpDiv, 'table', this.vDivId + '_ChartTableHead', 'gcharttableh');
                        vTmpTBody = this.newNode(vTmpTab, 'tbody');
                        vTmpRow = this.newNode(vTmpTBody, 'tr');
                        ...
                        vTmpDiv = this.newNode(vRightTable, 'div', this.vDivId + '_OSgwn_GANTT_CHART_BODY', 'gchartlbl gcontainercol gantt-chart-row-list-body');
                        this.setChartBody(vTmpDiv);
                        vTmpTab = this.newNode(vTmpDiv, 'table', this.vDivId + '_ChartTableBody', 'gcharttable', null, vTaskLeftPx);
                        ...
                        for (i = 0; i < this.vTaskList.length; i++) {
                            ...
                            if (this.vTaskList[i].getMile() && !vComb) {
                                ...
                                if (this.vTaskList[i].getGroup()) {
                                    ...
                                    this.vTaskList[i].setTaskDiv(vTmpDiv2);
                                    // PLANNED
                                    if (vTaskPlanLeftPx && vTaskPlanLeftPx != vTaskLeftPx || vTaskPlanRightPx && vTaskPlanRightPx != vTaskRightPx) {
                                        var vTmpPlanDiv = this.newNode(vTmpDivCell, 'div', this.vDivId + 'planbardiv_' + vID, 'gtaskbarcontainer gplan', null, vTaskPlanRightPx, vTaskPlanLeftPx);
                                        this.vTaskList[i].setPlanBarDiv(vTmpPlanDiv);
                                        var vTmpDiv3 = this.newNode(vTmpPlanDiv, 'div', this.vDivId + 'plantaskbar_' + vID, this.vTaskList[i].getClass() + ' gplan', null, vTaskPlanRightPx);
                                        this.vTaskList[i].setTaskPlanDiv(vTmpDiv3);
                                    }
                            ...
                            if (this.getCaptionType() && vCaptClass !== null) {
                                ...
                                if (vTmpItem.getMile()) {
                                    vCaptionStr = vTmpItem.getName();
                                    this.newNode(vTmpDiv, 'div', null, vCaptClass, vCaptionStr, null, (vCaptClass == 'gmilecaption') ? 12 : 0);
                                } else {
                                    this.newNode(vTmpDiv, 'div', null, vCaptClass, vCaptionStr, 120, (vCaptClass == 'gmilecaption') ? 12 : 0);
                                }
                            }
                            // Add Task Info div for tooltip
                            if ((this.vTaskList[i].getTaskDiv() || this.vTaskList[i].getTaskPlanDiv()) && vTmpDiv) {
                    ...
                    if (typeof(this.vGanttPostDraw) != null) {
                        if (typeof(this.vGanttPostDraw) == 'function') {
                            this.vGanttPostDraw(this);
                        }
                    }
                }; //this.draw
                ...
                if (editable) {
                    switch (type) {
                        case 'date':
                            ...
                            var vYYYY = '' + vDate.getFullYear();
                            var vMM = vDate.getMonth() + 1;
                            if (vMM < 10) {
                                vMM = '0' + vMM;
                            } else {
                                vMM = '' + vMM;
                        ...
                        case 'percentage':
                            return "<input class=\"gantt-inputtable\" type=\"percentage\" min=\"0\" max=\"100\" value=\"" + (value ? value : '') + "\">";
                        case 'number':
                            return "<input class=\"gantt-inputtable\" type=\"number\" value=\"" + (value ? value : '') + "\">";
                        default:
            ...
            exports.updateFlyingObj = function(e, pGanttChartObj, pTimer) {
                ...
                if (pGanttChartObj.getUseMove()) {
                    ...
                    pGanttChartObj.vTool.moveInterval = setInterval(function() {
                        events_1.moveToolTip(vNewX, vNewY, pGanttChartObj.vTool, pTimer);
                    }, pTimer);
                } else {
        ...
        3: [function(require, module, exports) {
                ...
                if (pGanttChartObj.getUseToolTip()) {
                    if (pGanttChartObj.vTool == null) {
                        ...
                        this.addListener('mouseout', function() {
                            utils_1.delayedHide(pGanttChartObj, pGanttChartObj.vTool, pTimer);
                        }, pGanttChartObj.vTool);
                    }
                    clearTimeout(pGanttChartObj.vTool.delayTimeout);
                    ...
                    if (pGanttChartObj.getUseFade()) {
                        ...
                        pGanttChartObj.vTool.fadeInterval = setInterval(function() {
                            utils_1.fadeToolTip(1, pGanttChartObj.vTool, vMaxAlpha);
                        }, pTimer);
                    } else {
            ...
            exports.addFormatListeners = function(pGanttChart, pFormat, pObj) {
                exports.addListener('click', function() {
                    utils_1.changeFormat(pFormat, pGanttChart);
                }, pObj);
            };
            exports.addScrollListeners = function(pGanttChart) {
                exports.addListener('resize', function() {
                    try {
                        ...
                        //console.log('SET pGanttChart.getChartHead().scrollLeft ERROR: '+e.message);
                    }
                }, window);
                exports.addListener('resize', function() {
                    try {
                        ...
                        //console.log('SET pGanttChart.getListBody().scrollTop ERROR: '+e.message);
                    }
                }, window);
            };
            ...
            exports.addListenerDependencies = function() {
                ...
                for (var i = 0; i < elements.length; i++) {
                    ...
                    if (document.addEventListener) {
                        ...
                        taskDiv.attachEvent('onmouseover', function(e) {
                            toggleDependencies(e);
                        });
                        taskDiv.attachEvent('onmouseout', function(e) {
                            toggleDependencies(e);
                        });
                    }
                }
            ...
            var toggleDependencies = function(e) {
                ...
                if (ids.length > 1) {
                    var frameZones;
                    if (Array.from) {
                        frameZones = Array.from(document.querySelectorAll(".gDepId" + ids[1]));
                    } else {
                        frameZones = [].slice.call(document.querySelectorAll(".gDepId" + ids[1]));
                    }
                    frameZones.forEach(function(c) {
                        c.style.borderStyle = style;
                        c.style.borderColor = bkColor;
        ...
        7: [function(require, module, exports) {
            ...
            exports.includeGetSet = function() {
                ...
                this.setShowTaskInfoPlanStartDate = function(pVal) {
                    this.vShowTaskInfoPlanStartDate = pVal;
                };
                this.setShowTaskInfoPlanEndDate = function(pVal) {
                    this.vShowTaskInfoPlanEndDate = pVal;
                };
                ...
                this.setDateTaskTableDisplayFormat = function(pVal) {
                    this.vDateTaskTableDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setDateTaskDisplayFormat = function(pVal) {
                    this.vDateTaskDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setHourMajorDateDisplayFormat = function(pVal) {
                    this.vHourMajorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setHourMinorDateDisplayFormat = function(pVal) {
                    this.vHourMinorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setDayMajorDateDisplayFormat = function(pVal) {
                    this.vDayMajorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setDayMinorDateDisplayFormat = function(pVal) {
                    this.vDayMinorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setWeekMajorDateDisplayFormat = function(pVal) {
                    this.vWeekMajorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setWeekMinorDateDisplayFormat = function(pVal) {
                    this.vWeekMinorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setMonthMajorDateDisplayFormat = function(pVal) {
                    this.vMonthMajorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setMonthMinorDateDisplayFormat = function(pVal) {
                    this.vMonthMinorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setQuarterMajorDateDisplayFormat = function(pVal) {
                    this.vQuarterMajorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                this.setQuarterMinorDateDisplayFormat = function(pVal) {
                    this.vQuarterMinorDateDisplayFormat = utils_1.parseDateFormatStr(pVal);
                };
                ...
                this.setEditInputEnable = function(editable) {
                    this.vEditInputEnable = editable;
                };
                ...
                this.getShowTaskInfoPlanStartDate = function() {
                    return this.vShowTaskInfoPlanStartDate;
                };
                this.getShowTaskInfoPlanEndDate = function() {
                    return this.vShowTaskInfoPlanEndDate;
                };
        ...
        8: [function(require, module, exports) {
            ...
            exports.folder = function(pID, ganttObj) {
                if (ganttObj.vGanttQueryFolderClick != null) {
                    if (typeof(ganttObj.vGanttQueryFolderClick) == 'function') {
                        ganttObj.vGanttQueryFolderClick(ganttObj);
                    }
                }
                ...
                if (ganttObj.vGanttPostFolderClick != null) {
                    if (typeof(ganttObj.vGanttPostFolderClick) == 'function') {
                        ganttObj.vGanttPostFolderClick(ganttObj);
                    }
                }
            };
            ...
            exports.TaskItem = function(pID, pName, pStart, pEnd, pClass, pLink, pMile, pRes, pComp, pGroup, pParent, pOpen, pDepend, pCaption, pNotes, pGantt, pCost, pPlanStart, pPlanEnd, pDataObject) {
                ...
                var vCost = parseFloat(document.createTextNode(pCost).data);
                var vGroup = parseInt(document.createTextNode(pGroup).data);
                var vDataObject = pDataObject;
                var vCompVal;
                var vParentOriginal = document.createTextNode(pParent).data;
                var parent = vParentOriginal;
                if (parent && parent !== '0') {
                ...
                this.getDependOriginal = function() {
                    if (vDependOriginal)
                        return vDependOriginal;
                    else
                        return null;
                };
                ...
                this.getParentOriginal = function() {
                    return vParentOriginal;
                };
                ...
                this.setCaption = function(p) {
                    vCaption = document.createTextNode(p).data;
                };
                this.setDepend = function(vPara) {
                    var vDependStr = vPara + '';
                    var vDepList = vDependStr.split(',');
                    vDependOriginal = vDepList;
                    var n = vDepList.length;
                    for (var k = 0; k < n; k++) {
                ...
                this.setDependOriginal = function(vPara) {
                    this.setDepend(vPara);
                };
                this.setParent = function(vPara) {
                    vParent = vPara;
                };
                this.setParentOriginal = function(vPara) {
                    vParentOriginal = vPara;
                    var parent = vParentOriginal;
                    if (parent && parent !== '0') {
                        parent = utils_1.hashKey(parent).toString();
                    }
                ...
                this.setMile = function(pPara) {
                    vMile = parseInt(pPara);
                };
                this.setNotes = function(pPara) {
                    vNotes = document.createElement('span');
                    vNotes.className = 'gTaskNotes';
                    if (pNotes != null) {
                        vNotes.innerHTML = pPara;
                    }
                };
                this.setClass = function(pPara) {
                    vClass = document.createTextNode(pPara).data;
                };
                this.setCost = function(pCost) {
                    vCost = parseFloat(pCost);
                };
                ...
                this.setCompVal = function(pComp) {
                    vComp = parseFloat(document.createTextNode(pComp).data);
                };
                this.setCost = function(pCost) {
                    vCost = parseFloat(document.createTextNode(pCost).data);
                };
                ...
                this.setPlanStartX = function(pX) {
                    px1 = parseInt(document.createTextNode(pX).data);
                };
                this.setPlanStartY = function(pY) {
                    py1 = parseInt(document.createTextNode(pY).data);
                };
                this.setPlanEndX = function(pX) {
                    px2 = parseInt(document.createTextNode(pX).data);
                };
                this.setPlanEndY = function(pY) {
                    py2 = parseInt(document.createTextNode(pY).data);
                };
                ...
                this.setTaskPlanDiv = function(pDiv) {
                    if (typeof HTMLDivElement !== 'function' || pDiv instanceof HTMLDivElement)
                        vTaskDiv = pDiv;
                };
            ...
            exports.createTaskInfo = function(pTask) {
                ...
                if (this.vShowTaskInfoRes == 1) {
                    ...
                    if (this.vResources != null) {
                        for (var i = 0; i < this.vResources.length; i++) {
                            if (pTask.getResource() == this.vResources[i].id) {
                                resText = this.vResources[i].name
                                break;
                            }
                        }
                    }
                    if (resText != '') {
                        this.newNode(vTmpDiv, 'span', null, 'gTaskText', resText);
                    } else {
        ...
        9: [function(require, module, exports) {
            ...
            exports.getMinDate = function(pList, pFormat) {
                ...
                // Parse all task plantstart to find min
                for (var i = 0; i < pList.length; i++) {
            ...
            exports.getMaxDate = function(pList, pFormat) {
                ...
                // Parse all Task plan end dates to find max
                for (var i = 0; i < pList.length; i++) {
            ...
            exports.parseDateStr = function(pDateStr, pFormatStr) {
                ...
                if (pDateStr.length >= 10 && vDateParts.length >= 3) {
                    while (vDateParts.length < 6) {
                        vDateParts.push(0);
                    }
                    switch (pFormatStr) {
                        case 'mm/dd/yyyy':
                            vDate = new Date(vDateParts[2], vDateParts[0] - 1, vDateParts[1], vDateParts[3], vDateParts[4], vDateParts[5]);
                            break;
                        case 'dd/mm/yyyy':
                            vDate = new Date(vDateParts[2], vDateParts[1] - 1, vDateParts[0], vDateParts[3], vDateParts[4], vDateParts[5]);
                            break;
                        case 'yyyy-mm-dd':
        ...
        10: [function(require, module, exports) {
            ...
            exports.getJSONTask = function(pID) {
                ...
                if (vIdx >= 0 && vIdx < this.vTaskList.length) {
                    ...
                    json['pPlanStart'] = utils_1.formatDateStr(this.vTaskList[vIdx].getPlanStart(), vOutFrmt, this.vLangs[this.vLang]);
                    json['pPlanEnd'] = utils_1.formatDateStr(this.vTaskList[vIdx].getPlanEnd(), vOutFrmt, this.vLangs[this.vLang]);
                    ...
                    json['pParent'] = this.vTaskList[vIdx].getParentOriginal();
                    json['pOpen'] = this.vTaskList[vIdx].getOpen();
                    json['pDepend'] = this.vTaskList[vIdx].getDependOriginal().join(',');
            ...
            exports.getXMLTask = function(pID) {
                ...
                if (vIdx >= 0 && vIdx < this.vTaskList.length) {
                    ...
                    vTask += '<pPlanStart>' + utils_1.formatDateStr(this.vTaskList[vIdx].getPlanStart(), vOutFrmt, this.vLangs[this.vLang]) + '</pPlanStart>';
                    vTask += '<pPlanEnd>' + utils_1.formatDateStr(this.vTaskList[vIdx].getPlanEnd(), vOutFrmt, this.vLangs[this.vLang]) + '</pPlanEnd>';
                    ...
                    vTask += '<pParent>' + this.vTaskList[vIdx].getParentOriginal() + '</pParent>';
                    vTask += '<pOpen>' + this.vTaskList[vIdx].getOpen() + '</pOpen>';
                    vTask += '<pDepend>' + this.vTaskList[vIdx].getDependOriginal().join(',') + '</pDepend>';
