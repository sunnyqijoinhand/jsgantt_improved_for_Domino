...
(function(f) {
    ...
    return (function e(t, n, r) {
        ...
        2: [function(require, module, exports) {
            ...
            // pGanttHeight: (requored) - used to control gantt's height
            exports.GanttChart = function(pDiv, pFormat, pGanttHeight) {
                ...
                this.Draw = function() {
                    ...
                    if (this.vTaskList.length > 0) {
                         ...
                         *
                         */
                        vTmpDiv = this.newNode(vLeftHeader, 'div', this.vDivId + '_OSgwn_GANTT_LIST_BODY', 'glistlbl gcontainercol');
                        ...
                        vTmpDiv = this.newNode(vRightTable, 'div', this.vDivId + '_OSgwn_GANTT_CHART_BODY', 'gchartlbl gcontainercol');
...
function DomPortalUI_Gantt(gantt_div_id, gantt_format, gantt_height, gantt_data_json_url, gantt_config_options, before_draw_gantt, after_draw_gantt, gantt_events) {
    if ($.trim(gantt_data_json_url) == '')
        return;
    if ($(gantt_div_id).length == 0)
        return;
    gantt_format = gantt_format.toLowerCase();
    if (gantt_format != 'day' && gantt_format != 'week' && gantt_format != 'month' && gantt_format != 'quarter') {
        gantt_format = 'day';
    }
    ...
    if (typeof(DomPortalUI_LangPackStrings['gantt-lang']) != 'undefined') {
        g.addLang('OSgwn_domportal_gantt_lang_OS', DomPortalUI_LangPackStrings['gantt-lang']);
        g.setLang('OSgwn_domportal_gantt_lang_OS');
    }
